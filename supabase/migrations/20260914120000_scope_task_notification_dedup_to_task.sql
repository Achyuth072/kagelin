-- Distinguish pending task reminders by reference_id so distinct tasks due
-- at the same instant do not collide and drop reminders.
DROP INDEX IF EXISTS public.notification_queue_pending_dedup_idx;
