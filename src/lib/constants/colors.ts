...
export const PROJECT_COLORS: ProjectColor[] = [
  ...
  { name: "Crimson", hex: "#9C4A4A" },
  { name: "Amber", hex: "#B8934A" },
  { name: "Gold", hex: "#C4A85C" },
  { name: "Teal", hex: "#4A8A8A" },
  { name: "Cerulean", hex: "#4A7BA8" },
  { name: "Amethyst", hex: "#7B5C9C" },
  { name: "Rose", hex: "#B85C7B" },
