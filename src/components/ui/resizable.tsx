...
const ResizableHandle = ({
  ...
  <Separator
    className={cn(
      ...
      "transition-seijaku-fast hover:after:bg-sidebar-border cursor-col-resize",
      className,
    )}
    {...props}
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border border-border/80 bg-background">
        <svg
          width="15"
          height="15"
          viewBox="0 0 15 15"
