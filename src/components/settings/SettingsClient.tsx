...
// Shared with the desktop header/tabs so the framed column stays aligned —
// see `project_kagelin-settings-layout-rules` memory for the reasoning.
const DESKTOP_CONTENT_WIDTH = "md:max-w-224 md:px-8";
  ...
  return (
    <>
      <div className="flex flex-col min-h-[calc(100svh-4rem)] p-4 md:p-6 gap-6 md:gap-8 relative overflow-hidden scrollbar-hide">
        ...
        <div className={cn("hidden md:block", DESKTOP_CONTENT_WIDTH)}>
        ...
        <main
          className={cn(
            "space-y-8 md:space-y-12 flex flex-col flex-1",
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-lg border border-brand/20 bg-brand/5">
                  <p className="text-xs text-muted-foreground mb-4">
                    Your data is stored locally in your browser. Sign in to sync
                    your data across devices and ensure it&apos;s never lost.
                  </p>
