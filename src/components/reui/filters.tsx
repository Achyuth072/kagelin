...
function FilterRemoveButton({
  ...
  return (
    <Button
      variant="outline"
      size={
        context.size === "sm" ? "sm" : context.size === "lg" ? "lg" : "icon"
      }
      ...
      <DropdownMenuContent align="start" className="w-fit min-w-fit">
        {operators.map((op) => (
          <DropdownMenuItem
            ...
            className={cn(
              "data-highlighted:bg-accent data-highlighted:text-accent-foreground flex items-center justify-between min-h-[44px] py-2",
            )}
          >
            <span>{op.label}</span>
            <CheckIcon
...
function SelectOptionsPopover<T = unknown>({
      ...
      {field.searchable !== false && (
        <>
          <Input
            ...
            className={cn(
              "border-input h-10 min-h-[44px] rounded-none border-0 bg-transparent! px-2 text-sm shadow-none",
                ...
                {filteredSelectedOptions.map((option, index) => {
                  ...
                  return (
                    <DropdownMenuCheckboxItem
                      ...
                      checked={true}
                      className={cn(
                        "data-highlighted:bg-accent data-highlighted:text-accent-foreground min-h-[44px] py-2",
                        option.className,
                      )}
                      onSelect={(e) => {
  ...
  return (
    ...
    >
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size={context.size} className="min-h-[44px]">
      ...
      {field.searchable !== false && (
        <>
          <Input
            ...
            className={cn(
              "h-10 min-h-[44px] rounded-none border-0 bg-transparent! px-2 text-sm shadow-none",
              "focus-visible:border-border focus-visible:ring-0 focus-visible:ring-offset-0",
...
export function Filters<T = unknown>({
  ...
  const triggerButton = isValidElement(trigger) ? (
    ...
    <Button variant="outline" size={size} className="min-h-[44px]">
                      ...
                      return filteredFields.map((field, index) => {
                          ...
                          return (
                            ...
                            >
                              <DropdownMenuSubTrigger
                                ...
                                className="data-popup-open:bg-accent data-popup-open:text-accent-foreground data-highlighted:bg-accent data-highlighted:text-accent-foreground min-h-[44px]"
                              >
                                {field.icon}
                        ...
                        return (
                          <DropdownMenuItem
                            ...
                            className="data-highlighted:bg-accent data-highlighted:text-accent-foreground min-h-[44px] py-2"
                          >
                            {field.icon}
                            <span>{field.label}</span>
                          </DropdownMenuItem>
